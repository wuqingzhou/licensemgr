        ...
        <div class="col-md-6">
            <form action="/license/update" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="province" value="${license.province}" class="form-control" placeholder="省份"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="clusterName" value="${license.clusterName}" class="form-control" placeholder="集群名称"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">集群节点数：</label>
                    <div class="col-md-10">
                        <input type="text" name="clusterNum" value="${license.clusterNum}" class="form-control" placeholder="集群节点数"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">有效天数：</label>
                    <div class="col-md-10">
                        <input type="text" name="activeDay" value="${license.activeDay}" class="form-control" placeholder="有效天数"/>
                    </div>
                </div>
                <div class="form-group">
